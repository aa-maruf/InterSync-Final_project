...
public class User_dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggle = new ActionBarDrawerToggle(User_dashboard.this, drawerLayout, R.string.open, R.string.close);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.mHome) {
                    Toast.makeText(User_dashboard.this, "Clicked", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(User_dashboard.this, User_dashboard.class);
                    startActivity(intent);
                    finish();
                    drawerLayout.closeDrawers();
                } else if (item.getItemId() == R.id.mlogout) {
                    Toast.makeText(User_dashboard.this, "Logout Successfully", Toast.LENGTH_SHORT).show();
